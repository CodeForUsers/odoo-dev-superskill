...
<!-- List View Template for Odoo 18.0 / 19.0 -->
<!-- IMPORTANT: In these versions, use <list> instead of <tree>. -->
<!-- Replace all {{ placeholders }} with actual values. -->
<odoo>

    <!-- List View -->
    <record id="{{ module_name }}.view_{{ model_underscore }}_list" model="ir.ui.view">
        <field name="name">{{ model.name }}.list</field>
        <field name="model">{{ model.name }}</field>
        <field name="arch" type="xml">
            <list string="{{ model_title }}"
                  editable="bottom"
